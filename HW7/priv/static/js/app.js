...
function update_buttons() {
  (0, _jquery2.default)('.manage-button').each(function (_, bb) {
    ...
    var mid = (0, _jquery2.default)(bb).data('user-manager-id');
...
function set_button(user_id, value) {
  (0, _jquery2.default)('.manage-button').each(function (_, bb) {
    if (user_id == (0, _jquery2.default)(bb).data('user-id')) {
      (0, _jquery2.default)(bb).data('user-manager-id', value);
    }
  });
  update_buttons();
}
...
function manage(user_id, manager_id) {
  ...
  _jquery2.default.ajax("/userupdate", {
    method: "post",
    dataType: "json",
...
function manage_click(ev) {
  ...
  var mid = btn.data('user-manager-id');
...
function update_buttons_timetrack() {
  (0, _jquery2.default)('.timetrack-button').each(function (_, bb) {
    var task_id = (0, _jquery2.default)(bb).data('task-id');
    var active_id = (0, _jquery2.default)(bb).data('active-id');

    if (active_id == "yes") {
      (0, _jquery2.default)(bb).text("Stop Task");
    } else {
      (0, _jquery2.default)(bb).text("Start Task");
    }
  });
}
...
function set_button_toggle(task_id, value) {
  (0, _jquery2.default)('.timetrack-button').each(function (_, bb) {
    if (task_id == (0, _jquery2.default)(bb).data('task-id')) {
      (0, _jquery2.default)(bb).data('active-id', value);
    }
  });
...
function stopTask(task_id) {
  enddt = new Date(_jquery2.default.now());
  ...
  _jquery2.default.ajax(timetrack, {
    method: "post",
    dataType: "json",
    contentType: "application/json; charset=UTF-8",
    data: text,
...
function startTask(task_id) {
  strtdt = new Date(_jquery2.default.now());
  set_button_toggle(task_id, "yes");
}

function timetrack_click(ev) {
  var btn = (0, _jquery2.default)(ev.target);
  var tid = btn.data('task-id');
  var active_id = btn.data('active-id');
...
function init_manage() {
  ...
  (0, _jquery2.default)(".timetrack-button").click(timetrack_click);
